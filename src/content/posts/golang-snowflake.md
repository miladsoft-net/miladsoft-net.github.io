...
An **Lock Free** ID Generator for Golang implementation [View on GitHub](https://github.com/miladsoft/go-snowflake).

![file](https://images.miladsoft.net/logos/201908/13/_1565672621_LPW65Pi8cG.png)
...
```shell
$ go get github.com/miladsoft/go-snowflake
```
...
import (
    ...
    "github.com/miladsoft/go-snowflake"
)
