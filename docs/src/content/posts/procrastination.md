...
description: "三年前在 Github 发布了一个图片识别的 PHP 扩展包 miladsoft/ocr，主要功能是整合几大厂商的图片识别接口，方便统一调用。"
...
三年前在 Github 发布了一个图片识别的 PHP 扩展包 miladsoft/ocr，主要功能是整合几大厂商的图片识别接口，方便统一调用。

当初设计都比较简单，基本是能用就行；

~~一年后觉得自己技术牛逼了，知识过硬了~~ ，打算重新发布个版本，已更新下那难看的 last commit，随便慰藉自己当初开源的初衷 ~~吗~~ 。

![file](https://images.miladsoft.net/posts/202011/20/XxGFVtWBpE1oZrXOKMilhvyEAC37wY5Rz54ICxE8.png)

然后大刀阔斧的开整，结果婚结完了，朋友朋友的婚都结完了、两年过去了，我才重构了 20%。

![file](https://images.miladsoft.net/posts/202011/20/0sOuuR4nm7niUNczcpwxX0akfS03wOeWWRzM45gs.png)
...
```php
use Miladsoft\OCR\Support\Response;
