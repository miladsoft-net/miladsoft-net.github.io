...
![Laravel Octane RoadRunner](https://images.miladsoft.net/posts/202104/29/XgEntLO1b4ouj3TG9Hv3T7H63GNQibLQBwNzH7sx.png)
...
![Laravel Swoole](https://images.miladsoft.net/posts/202104/29/4fZ6XuboeSdtVIjCYrG6Pk9tXE9tc20oywd0Z5kA.png)
...
否则可能会出现如 Class "Miladsoft\Snowflake\Snowflake" not found 的错误。

## Laravel Octane 是线程安全的吗？
在回答这个问题之前，我们先来看看 Laravel Octane 的请求处理流程。

![Laravel Octane](https://images.miladsoft.net/posts/202104/29/GUz7CA0H2G9SR2GXbiWHvvkQfkuyeUr5lXsMTE2b.png)
...
* FastCgi 与 PHP-fpm 之间的关系 https://miladsoft.net/posts/the-relationship-between-fastcgi-and-php-fpm
