...
![违反隔离性](https://images.miladsoft.net/posts/202108/03/TOkq5GTlht12ZxSelk36r3vnfOWAjAegEO0ks1n0.png)
...
![Read Committed](https://images.miladsoft.net/posts/202108/03/xh2K3QGq0kVQ4G1vUFgB7ZGCupRMK2pI0N9M4goS.png)
...
![Read Committed](https://images.miladsoft.net/posts/202108/03/uiq6yVja58bw5FnIJO9aVLCOCDFJrtDBwOVMm2fH.png)
...
![多版本并发控制](https://images.miladsoft.net/posts/202108/03/E44vsatw2Nw3XlU5MmtBPWgJIDUFpI9nadnHc03e.png)
**图 3.0 多版本控制**
...
![Lost Update](https://images.miladsoft.net/posts/202108/03/7Gg9fRNx3X2q7uvjHwmffk2YxiWwvotqs426GNQr.png)
**图 3.1 Lost Update**
...
虽然文章标题叫做「[为什么我们需要数据库事务](https://miladsoft.net/posts/why-do-we-need-database-transactions)」，但其实作者大部分篇幅都在写隔离级别，因为我发现再解释完为什么后，还需要接着解释 Why，那姑且就这样吧。如果你觉得文章对你有帮助，你也可以订阅作者的博客 [RSS](https://blog.miladsoft.net/feeds) 或直接访问作者博客 [二愣的闲谈杂鱼](https://miladsoft.net/)。
...
* [原文链接 - 为什么我们需要数据库事务？](https://miladsoft.net/posts/why-do-we-need-database-transactions)
